...
public class RestaurantsControllerTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    private readonly Mock<IRestaurantsRepository> _mockRestaurantsRepository = new(); 
   public RestaurantsControllerTests(WebApplicationFactory<Program> factory)
        ...
        _factory = factory.WithWebHostBuilder(builder =>
        {
            builder.ConfigureTestServices(services =>
            {
                ...
                services.Replace(ServiceDescriptor.Scoped(typeof(IRestaurantsRepository),
                    _ => _mockRestaurantsRepository.Object));
            });
        });
    }
    [Fact()]
    public async Task GetById_ForExisting_ShouldReturn200OK()
    {
        //arrange
        var id = 99;
        ...
        _mockRestaurantsRepository.Setup(m => m.GetByIdAsync(id)).ReturnsAsync(restaurant);
    ...
    public async Task GetById_ForNonExisting_ShouldReturn404NotFound()
    {
        ...
        _mockRestaurantsRepository.Setup(m => m.GetByIdAsync(id)).ReturnsAsync((Restaurant?) null);
        var client =  _factory.CreateClient();
